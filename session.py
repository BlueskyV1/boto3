...
from emcboto3.auth import EmcEcsHmacV1Auth
...
class Session(object):
    ...
    def __init__(self, aws_access_key_id=None, aws_secret_access_key=None,
        ...
        botocore.loaders.Loader.CUSTOMER_DATA_PATH = '/usr/local/lib/python3.6/site-packages/emcboto3'
        emcecsdict = {'emcecs': EmcEcsHmacV1Auth}
        botocore.auth.AUTH_TYPE_MAPS.update(emcecsdict)
    ...
    def get_available_resources(self):
        ...
        :return: List of service names
        """
        return self._loader.list_available_services(type_name='service-2')
    ...
    # Holdover from master session; these don't exist in the EMCECS implementation
